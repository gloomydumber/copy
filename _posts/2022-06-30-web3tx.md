...
Actually, I can't find certain difference between `web3.eth.sendTransaction` and `web3.eth.personal.sendTransaction` for now.

I issued Questions on _Web3.js_ github repository & Ethereum StackExchange. questions are pending for answer for now.

([Ethereum StackExchange](https://ethereum.stackexchange.com/questions/130977/what-is-difference-between-web3-eth-sendtransaction-and-web3-eth-personal-sendtr){: target="\_blank"})

([Web3.js Repository Issues](https://github.com/ChainSafe/web3.js/issues/5191){: target="\_blank"})
